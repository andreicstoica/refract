...
- Add Mermaid definitions (`*.mmd`) in this folder. Use lowercase, hyphenated filenames that match the feature area (e.g., `writing-flow.mmd`, `prod-queue.mmd`).
...
- Existing diagrams:
	- `writing-flow.mmd` — editor → hooks → providers → overlays.
